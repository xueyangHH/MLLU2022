...
class BoolQDataset(Dataset):
    ...
    def __init__(self, dataframe, tokenizer, max_seq_length=256):
        ...
        i_i, a_m = data_utils.encode_data(dataframe, tokenizer, max_seq_length)
        self.encoded_data = [i_i, a_m]
    ...
    def __getitem__(self, i):
        ...
        example['attention_mask'] = self.encoded_data[1][i]
        example['labels'] = self.label_list[i]
        return example
